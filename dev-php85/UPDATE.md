# PHP 8.5.7 Upgrade — `ctw/ctw-middleware-tidy`
...
> Requires `ext-tidy` (present in this environment — tests ran).
...
| PHPUnit (`--no-coverage`, stale deps) | 5 tests, 11 assertions, **5 deprecations** (`middlewares/utils`, §2) |
